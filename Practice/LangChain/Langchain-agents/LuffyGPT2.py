...
#         response = agent_executor.invoke(history=history,
#                                          context=context,
#                                          input=user_input,
#                                          )
...
#             history=history,
#             context=context,
#             input=user_input_prompt.format(input=user_input),
#             )
#         print(f"Luffy: {response['content']}")
#     except Exception as e:
#         print(f"An error occurred: {e}")
...
#     # print("LLM model output: ", response.output)
#     # print("Parsed output: ", response.response)
#     return response
