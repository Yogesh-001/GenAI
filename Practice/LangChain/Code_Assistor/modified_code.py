...
prompt_template= """You are a Code Helper for Python. Your job is to analyze and review Python code {code} to identify any errors or inefficiencies. Once you have identified 
